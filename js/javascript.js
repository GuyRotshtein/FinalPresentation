window.onload = () =>{
    ...
    var eventDate = document.getElementsByClassName("checkDate")[0].textContent;
    //var eventDate = "2022-05-12";
    ...
    var status = document.getElementsByClassName("path")[3];

    if(diffYears == 0){
        if(diffMonth > 0){
            console.log("black");
            status.setAttribute("d","M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 3.5a.5.5 0 0 0-1 0V9a.5.5 0 0 0 .252.434l3.5 2a.5.5 0 0 0 .496-.868L8 8.71V3.5z");
        }else if (diffMonth == 0){
